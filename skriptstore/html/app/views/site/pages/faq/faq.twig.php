...
<div class="wrapper">
    ...
    <div class="static">
        ...
        <div class="b3 b3-2">
            ...
            Система Opcash основана на билетном алгоритме, который определяет число с учетом коэффицента и случайной
            генерации числа.
        </div>
        <div class="b3 b3-3">
        ...
        <div class="faq">
            ...
            Баланс на нашем сайте вы можете пополнить абсолютно разными способами: WebMoney, Яндекс.Деньги, Приват24,
            ЕвроСеть и т.п<br> Чтобы пополнить баланс, перейдите в свой личный кабинет и нажмите "Пополнить баланс"
        </div>
        <div class="faq">
            <div class="question">Как вывести средства?</div>
            Средства вы сможете вывести зайдя в свой профиль, нажав "Вывод средств"
        </div>
        <div class="faq">
            <div class="question">Как определяется приз?</div>
            Программа для вычисления победителя основана на генерации случайного числа исходя из процентного шанса
            приза. Чем дороже приз - тем меньше шанс выпадения.
        </div>
        <div class="faq">
            <div class="question">Что такое партнерский код?</div>
            Партнерский код - это код, благодаря которому Вы сможете <a <?php if ($user) { ?> href="/account/" <?php } else { ?> href="#" <?php } ?> title="Нажмите, чтобы продолжить, Not set">
                дополнительно зарабатывать<img src="http://cdncache-a.akamaihd.net/items/it/img/arrow-10x10.png" alt=""></a>
            на нашем проекте. Делитесь кодом с Вашими друзьями и получайте 5% от каждой транзакции.
        </div>
        <div class="faq">
            <div class="question">Куда вводить партнерский код?</div>
            Вводить партнерский код нужно в своем личном кабинете. За это вы получаете бонус в размере 10 рублей.
        </div>
        <div class="faq">
            <div class="question">Что такое увеличитель шанса?</div>
            Увеличитель шанса, дает вам шанс выиграть более дорогой приз чаще чем обычно. Чем выше ваш дополнительный
            шанс, тем больше вероятности, что вам выпадет более дорогой приз за маленькую плату.
        </div>
        <div class="faq">
            <div class="question">Я сделал запрос на вывод средств, но деньги не пришли.</div>
            Вывод средств производится в течении 24-х часов. Если, вдруг, средства не пришли в течении указанного
            времени - обратитесь в тех.поддержку.
        </div>
        <div class="touch-now text-center">
            <h3>Не нашли ответ на ваш вопрос?</h3>
            <a class="btn yellow rounded" href="support/">Задать вопрос</a></div>
    </div>
    <div class="cls"></div>
...
<script type="text/javascript">
VK.Widgets.Group("vk_groups", {mode: 4, wide: 1, width: "220", height: "400"}, 131358928);
</script>
<!-- VK BUTTON -->
