    ...
    <div class="account">
        ...
        <div class="userbox">
            <div class="l">
                ...
                <h1><?= $profile->name ?> <a href="https://vk.com/id<?= $profile->uid ?>" target="_blank"> <span class="flaticon-soc-vk"></span> </a> </h1>
                <div class="u-cases"><span class="flaticon-case"></span> Кейсы: <span class="n"><?= $this->length($drops) ?></span></div>
                <div class="u-money"><span class="flaticon-money"></span> Выигрыш: <span class="n"><?= $this->helper->getUserBank($profile->id) ?>р</span></div>
            </div>
            <div class="r">
            ...
            <?php if ($this->length($drops) > 0) { ?>
                <?php foreach ($drops as $drop) { ?>
                    <div class="history-case">
                        <a href="/case/<?= $drop->case_id ?>" class="eas case-url">Кейс №<?= $drop->case_id ?></a>
                        <div class="status"><span class="flaticon-check"></span></div>
                        <div class="coin silver">
                            <img src="<?= $this->helper->getItemInfo($drop->item_id)->image ?>" alt="<?= $this->helper->getItemInfo($drop->item_id)->name ?>">
                        </div>
                    </div>
                <?php } ?>
            <?php } else { ?>
